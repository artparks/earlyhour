	...
	<header class="entry-header">
		<div class="entry-meta">
			...
			<span class="entry-format">
				<a href="<?php echo esc_url( get_post_format_link( 'link' ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'All %s posts', 'hive_txtd' ), get_post_format_string( 'link' ) ) ); ?>">
		...
		<?php } else {
			the_title( '<h1 class="entry-title"><a href="' . esc_url( hive_get_post_format_link_url() ) . '" rel="bookmark">', '</a></h1>' );
		} ?>
	</header><!-- .entry-header -->
