...
function hive_add_customify_options( $options ) {
	...
	$options['sections'] = array(
		'presets_section' => array(
				'title'    => __( 'Style Presets', 'hive_txtd' ),
				'options' => array(
					'theme_style'   => array(
						'type'      => 'preset',
						'label'     => __( 'Select a style:', 'hive_txtd' ),
						'desc' => __( 'Conveniently change the design of your site with built-in style presets. Easy as pie.', 'hive_txtd' ),
						'default'   => 'hive',
						'choices_type' => 'awesome',
						'choices'  => array(
							'hive' => array(
								'label' => __( 'Hive', 'hive_txtd' ),
								'preview' => array(
									'color-text' => '#ffffff',
		...
		'colors_section' => array(
			...
			'options' => array(
				'accent_color'   => array(
					'type'      => 'color',
					'label'     => __( 'Accent Color', 'hive_txtd' ),
					'live' => true,
					'default'   => '#ffeb00',
					'css'  => array(
						array(
				...
				'border_color'	=> array(
					'type'      => 'color',
					'label'     => __( 'Border Color', 'hive_txtd' ),
					'live' => true,
					'default'   => '#171617',
					'css'  => array(
						array(
				...
				'border_text_color'	=> array(
					'type'      => 'color',
					'label'     => __( 'Border Text Color', 'hive_txtd' ),
					'live' => true,
					'default'   => '#ffffff',
					'css'  => array(
						array(
